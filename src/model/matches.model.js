        ...
        where userid in
              (
                ...
                WHERE ($1 in (userRelationship."userId1", userRelationship."userId2"))
                  ...
                  and (userRelationship."userId1" = userid and userRelationship."user1-towards-user2" not in('like','block')
                      or userRelationship."userId2" = userid and userRelationship."user2-towards-user1" not in('like','block') )
                  and userid != $1
                  )
